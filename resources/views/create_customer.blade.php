...
<form action="{{url('/')}}/database/crud/registration" method="POST" novalidate>
    @csrf
    <h1 class="text-center">Customer Registration</h1>
<div class="row jumbotron">
    <div class="col-sm-6 form-group">
        <label for="name"> Name</label>
        <input type="text" class="form-control" name="name" id="name" placeholder="Enter your name." required value={{old('name')}}>
    ...
    <div class="col-sm-12 form-group">
        ...
        <input type="address" class="form-control" name="address" id="address" placeholder="Enter your address" required value={{old('address')}}>
        <span class="text-danger">
            @error('address')
                {{$message}}
            @enderror
    ...
    <div class="col-sm-6 form-group">
        ...
        <input type="address" class="form-control" name="state" id="state" placeholder="Enter your state name" required value={{old('state')}}>
        <span class="text-danger">
            @error('state')
                {{$message}}
            @enderror
    ...
    <div class="col-sm-6 form-group">
        ...
        <input type="Date" name="dob" class="form-control" id="dob" placeholder="" required value={{old('dob')}}>
        <span class="text-danger">
            @error('dob')
                {{$message}}
            @enderror
